...
import {
  ...
  table,
  defaultQueryEditor,
} from 'src/AILab/fixtures';
import SqlEditorLeftBar from 'src/AILab/components/SqlEditorLeftBar';
import ResultSet from 'src/AILab/components/ResultSet';
...
jest.mock('src/AILab/components/SqlEditorLeftBar', () => jest.fn());
jest.mock('src/AILab/components/ResultSet', () => jest.fn());
