...
import { SaveDatasetModal } from 'src/AILab/components/SaveDatasetModal';
import { createDatasource } from 'src/AILab/actions/sqlLab';
import { user, testQuery, mockdatasets } from 'src/AILab/fixtures';
...
jest.mock('src/AILab/actions/sqlLab', () => ({
