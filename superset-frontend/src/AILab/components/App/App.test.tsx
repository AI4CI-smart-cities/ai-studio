...
import App from 'src/AILab/components/App';
import reducers from 'spec/helpers/reducerIndex';
import { LOCALSTORAGE_MAX_USAGE_KB } from 'src/AILab/constants';
...
jest.mock('src/AILab/components/TabbedSqlEditors', () => () => (
  <div data-test="mock-tabbed-sql-editors" />
));
jest.mock('src/AILab/components/QueryAutoRefresh', () => () => (
