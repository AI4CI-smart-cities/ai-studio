...
import TabbedSqlEditors from 'src/AILab/components/TabbedSqlEditors';
import { initialState } from 'src/AILab/fixtures';
import { newQueryTabName } from 'src/AILab/utils/newQueryTabName';
import { Store } from 'redux';
import { RootState } from 'src/views/store';
import { SET_ACTIVE_QUERY_EDITOR } from 'src/AILab/actions/sqlLab';

jest.mock('src/AILab/components/SqlEditor', () => () => (
